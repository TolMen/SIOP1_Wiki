...
Leur société était hautement structurée, avec une hiérarchie rigide dominée par le tlatoani, souverain suprême, assisté de conseillers et de prêtres influents. Les Aztèques étaient réputés pour leur puissance militaire, soumettant de nombreuses cités-États et exigeant des tributs, consolidant ainsi un vaste empire. <br>
La religion occupait une place centrale dans la vie aztèque, avec un panthéon riche en divinités telles que Huitzilopochtli, dieu de la guerre et du soleil, et Quetzalcoatl, le serpent à plumes. Les sacrifices humains étaient pratiqués pour apaiser les dieux et assurer la prospérité de l'empire. <br>
L'architecture aztèque se distinguait par des constructions impressionnantes, notamment le Templo Mayor, grand temple dédié aux principales divinités, situé au cœur de Tenochtitlan. La ville elle-même était un chef-d'œuvre d'ingénierie, avec ses canaux, ses chaussées et ses jardins flottants appelés chinampas, témoignant de leur maîtrise de l'environnement lacustre. <br>
...
Selon Hérodote, les Atlantes résidaient dans une région éloignée des Colonnes d'Héraclès, sur un « bourrelet sablonneux » à proximité de la montagne Atlas, décrite comme la « colonne du ciel ». Ils étaient réputés pour leur mode de vie particulier, notamment leur végétarisme et le fait qu'ils ne rêvaient pas.<br>
Le nom « Atlantes » a inspiré Platon pour nommer la civilisation fictive de l'Atlantide, présentée dans ses dialogues du « Critias » et du « Timée ». Cette civilisation mythique est décrite comme une puissance maritime avancée, qui aurait disparu après une catastrophe.<br>
...
Sous le règne de Sargon d'Akkad au XXIVᵉ siècle av. J.-C., les Akkadiens ont réussi à unifier une grande partie de la Mésopotamie, établissant ainsi le premier empire connu de l'histoire. Cette unification a favorisé les échanges culturels et commerciaux entre les différentes régions, consolidant l'influence mésopotamienne dans le Proche-Orient ancien.<br>
Babylone, fondée par les Amorrites au XVIIIᵉ siècle av. J.-C., est devenue un centre majeur de la Mésopotamie. Le roi Hammurabi (1792-1750 av. J.-C.) est célèbre pour avoir promulgué le Code de Hammurabi, l'un des premiers codes de lois écrits, qui a influencé les systèmes juridiques ultérieurs. Babylone était également renommée pour ses avancées en astronomie, en mathématiques et pour ses jardins suspendus, l'une des sept merveilles du monde antique.<br>
...
<br>Leur principale contribution à l’histoire est leur invention de l’alphabet phénicien, un système d’écriture simple et pratique qui a servi de base aux alphabets grec, latin et hébreu. Ce développement a révolutionné la communication et facilité les échanges commerciaux et culturels.
...
<br>Les Mycéniens étaient des guerriers redoutables, et leurs récits ont inspiré les épopées d’Homère, comme L’Iliade et L’Odyssée. Leur société était hiérarchisée, dirigée par des rois locaux appelés wanax, résidant dans des palais entourés de fortifications massives en pierre, connues sous le nom de « murailles cyclopéennes ».
...
<br>Les Incas ont développé une société hautement organisée, avec une administration centralisée et une infrastructure impressionnante. Le réseau routier inca, s'étendant sur des milliers de kilomètres, facilitait les communications et le contrôle des vastes territoires. Les chasquis, messagers rapides, parcouraient ces routes pour transmettre des informations à travers l'empire.
<br>L'agriculture était au cœur de l'économie inca. Grâce à des techniques ingénieuses comme les terrasses de culture et des systèmes d'irrigation avancés, ils cultivaient une variété de produits tels que le maïs, la pomme de terre et le quinoa. L'élevage de camélidés, comme les lamas et les alpagas, fournissait de la laine, de la viande et servait de moyen de transport.

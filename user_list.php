                        ...
                        <div class="modal fade" id="bandef<?php echo $user["userid"]; ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <?php if ($user["user_id"] == null && $user["role"] != "admin") { ?>
                                        <div class="col-3"><img src="assets/img/bantemp.png" alt="+" data-bs-toggle="modal"
                                                data-bs-target="#bantemp<?php echo $user["userid"]; ?>"
                                                style="cursor: pointer; width: 40px;"></div>
                                        <div class="modal fade" id="bantemp<?php echo $user["userid"]; ?>" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <!-- Titre -->
                                                        <h5 class="modal-title" id="exampleModalLabel">Bannissement temporaire

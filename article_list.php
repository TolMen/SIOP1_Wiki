        ...
        <div class='userList row'>
            ...
            foreach ($articles as $article) { ?>
                <div class="userCase col-8">
                    ...
                    <!-- Informations -->
                    <div class="col-2">&nbsp;&nbsp;Voir plus<img src="assets/img/eye_popup.png" alt="+"
                            data-bs-toggle="modal" data-bs-target="#article<?php echo $article["id"]; ?>"
                            style="cursor: pointer; width: 15px;"></div>
                    <div class="modal fade" id="article<?php echo $article["id"]; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <!-- Titre -->
                                    <h5 class="modal-title" id="exampleModalLabel">Informations complémentaires</h5><button
                                ...
                                <div class="modal-body">
                                    ...
                                    ?><br>
                                    <a href="templateArt.php?articleID=<?php echo $article["id"] ?>">Lien de
                                        l'article</a><br>
                                </div>
                ...
                <div class="userCase col-1">
                    <div><img src="assets/svg/trash.svg" alt="+" data-bs-toggle="modal"
                            data-bs-target="#delete<?php echo $article["id"]; ?>" style="cursor: pointer; width: 40px;">
                    </div>
                    <div class="modal fade" id="delete<?php echo $article["id"]; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <!-- Titre -->
                                    <h5 class="modal-title" id="exampleModalLabel">Supprimer l'article</h5><button
                                        type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- Intérieur -->
                                    <h5>Voulez-vous supprimer l'article<br>"<?php echo $article["title"] ?>" ?</h5><br>
                                    <a href="src/control/ArtControl/deleteArt.php?articleID=<?php echo $article["id"] ?>"><button
                                            class="buttonSubmit">Supprimer</button></a>
                                </div>
                                <div class="modal-footer"></div>
                            </div>
                        </div>
